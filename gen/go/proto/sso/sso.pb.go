...
const file_proto_sso_sso_proto_rawDesc = "" +
	...
	"\bis_admin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsadminResponseB\x10Z\x0egen/go/sso;ssob\x06proto3"
...
var file_proto_sso_sso_proto_depIdxs = []int32{
	...
	4, // 2: auth.Auth.is_admin:input_type -> auth.IsAdminRequest
	1, // 3: auth.Auth.Register:output_type -> auth.RegisterResponse
	3, // 4: auth.Auth.Login:output_type -> auth.LoginResponse
	5, // 5: auth.Auth.is_admin:output_type -> auth.IsadminResponse
